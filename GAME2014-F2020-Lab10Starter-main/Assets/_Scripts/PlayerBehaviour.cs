...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    {
        m_dustTrail.GetComponent<Renderer>().material.SetColor("_Color", Color.yellow);
        m_dustTrail.Play();
    }

    private void PlayHitSounds()
    {
        var randomHitSounds = hitSounds[UnityEngine.Random.Range(0, 4)];
        randomHitSounds.Play();
    }
